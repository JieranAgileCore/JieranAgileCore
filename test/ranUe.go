...
import (
	...
	"github.com/JieranAgileCore/util/milenage"
	"github.com/JieranAgileCore/util/ueauth"
)
...
func GetAccessAndMobilitySubscriptionData() (amData models.AccessAndMobilitySubscriptionData) {
	return TestRegistrationProcedure.TestAmDataTable[TestRegistrationProcedure.JieranAgileCore_CASE]
}

func GetSmfSelectionSubscriptionData() (smfSelData models.SmfSelectionSubscriptionData) {
	return TestRegistrationProcedure.TestSmfSelDataTable[TestRegistrationProcedure.JieranAgileCore_CASE]
}

func GetSessionManagementSubscriptionData() (smfSelData []models.SessionManagementSubscriptionData) {
	return TestRegistrationProcedure.TestSmSelDataTable[TestRegistrationProcedure.JieranAgileCore_CASE]
}

func GetAmPolicyData() (amPolicyData models.AmPolicyData) {
	return TestRegistrationProcedure.TestAmPolicyDataTable[TestRegistrationProcedure.JieranAgileCore_CASE]
}

func GetSmPolicyData() (smPolicyData models.SmPolicyData) {
	return TestRegistrationProcedure.TestSmPolicyDataTable[TestRegistrationProcedure.JieranAgileCore_CASE]
}

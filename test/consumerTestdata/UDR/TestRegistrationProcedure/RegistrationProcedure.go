...
const (
	JieranAgileCore_CASE = "JieranAgileCore"
)
...
func init() {
	TestAmDataTable[JieranAgileCore_CASE] = models.AccessAndMobilitySubscriptionData{
		Gpsis: []string{
			"msisdn-0900000000",
		},
		Nssai: &models.Nssai{
	...
	TestSmfSelDataTable[JieranAgileCore_CASE] = models.SmfSelectionSubscriptionData{
	...
	TestAmPolicyDataTable[JieranAgileCore_CASE] = models.AmPolicyData{
		SubscCats: []string{
			"JieranAgileCore",
		},
	}

	TestSmPolicyDataTable[JieranAgileCore_CASE] = models.SmPolicyData{
	...
	TestSmSelDataTable[JieranAgileCore_CASE] = []models.SessionManagementSubscriptionData{
		{

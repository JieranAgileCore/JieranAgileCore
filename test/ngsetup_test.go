...
import (
	...
	amf_factory "github.com/JieranAgileCore/amf/pkg/factory"
	amf_service "github.com/JieranAgileCore/amf/pkg/service"
	ausf_factory "github.com/JieranAgileCore/ausf/pkg/factory"
	ausf_service "github.com/JieranAgileCore/ausf/pkg/service"
	"github.com/JieranAgileCore/nas/security"
	"github.com/JieranAgileCore/ngap"
	nrf_factory "github.com/JieranAgileCore/nrf/pkg/factory"
	nrf_service "github.com/JieranAgileCore/nrf/pkg/service"
	nssf_factory "github.com/JieranAgileCore/nssf/pkg/factory"
	nssf_service "github.com/JieranAgileCore/nssf/pkg/service"
	"github.com/JieranAgileCore/openapi/models"
	pcf_factory "github.com/JieranAgileCore/pcf/pkg/factory"
	pcf_service "github.com/JieranAgileCore/pcf/pkg/service"
	smf_factory "github.com/JieranAgileCore/smf/pkg/factory"
	smf_service "github.com/JieranAgileCore/smf/pkg/service"
	udm_factory "github.com/JieranAgileCore/udm/pkg/factory"
	udm_service "github.com/JieranAgileCore/udm/pkg/service"
	"github.com/JieranAgileCore/udm/pkg/suci"
	udr_factory "github.com/JieranAgileCore/udr/pkg/factory"
	udr_service "github.com/JieranAgileCore/udr/pkg/service"
...
func init() {
	...
	case multiAMF:
		...
		if err := mongoapi.SetMongoDB("JieranAgileCore", "mongodb://127.0.0.1:27017"); err != nil {
...
func TestNGSetup(t *testing.T) {
	...
	sendMsg, err = test.GetNGSetupRequest([]byte("\x00\x01\x02"), 24, "JieranAgileCore")
	assert.Nil(t, err)

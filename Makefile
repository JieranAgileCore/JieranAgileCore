...
LDFLAGS = -X github.com/JieranAgileCore/util/version.VERSION=$(VERSION) \
          -X github.com/JieranAgileCore/util/version.BUILD_TIME=$(BUILD_TIME) \
          -X github.com/JieranAgileCore/util/version.COMMIT_HASH=$(COMMIT_HASH) \
          -X github.com/JieranAgileCore/util/version.COMMIT_TIME=$(COMMIT_TIME)
...
WEBCONSOLE_LDFLAGS = -X github.com/JieranAgileCore/util/version.VERSION=$(VERSION) \
                     -X github.com/JieranAgileCore/util/version.BUILD_TIME=$(BUILD_TIME) \
                     -X github.com/JieranAgileCore/util/version.COMMIT_HASH=$(WEBCONSOLE_COMMIT_HASH) \
                     -X github.com/JieranAgileCore/util/version.COMMIT_TIME=$(WEBCONSOLE_COMMIT_TIME)

...
sudo ip link add JieranAgileCore-br type bridge
sudo ip link set JieranAgileCore-br up
sudo ip link set br-veth0 up
sudo ip link set br-veth0 master JieranAgileCore-br
...
for i in $(seq -f "%02g" 1 $UPF_NUM); do
    ...
    sudo ip link set "br-veth${i}" master JieranAgileCore-br
...
sudo ip link del JieranAgileCore-br

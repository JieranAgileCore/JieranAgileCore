...
func TestUpdate(t *testing.T) {
	...
	go func() { // udm server
		...
		udmLogPath := path_util.JieranAgileCorePath("JieranAgileCore/udmsslkey.log")
		udmPemPath := path_util.JieranAgileCorePath("JieranAgileCore/support/TLS/udm.pem")
		udmKeyPath := path_util.JieranAgileCorePath("JieranAgileCore/support/TLS/udm.key")
	...
	go func() { // fake udr server
		...
		udrLogPath := path_util.JieranAgileCorePath("JieranAgileCore/udrsslkey.log")
		udrPemPath := path_util.JieranAgileCorePath("JieranAgileCore/support/TLS/udr.pem")
		udrKeyPath := path_util.JieranAgileCorePath("JieranAgileCore/support/TLS/udr.key")
